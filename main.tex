...
\end{frontespizio}
\end{verbatim}
    Anche su \texttt{main.tex} bisogna inoltre includere, come nel caso di \texttt{frontespizio.tex}, il pacchetto necessario:
\begin{verbatim}
\usepackage{frontespizio}
\end{verbatim}    
...
\'E possibile procedere anche senza l'utilizzo di un secondo file \texttt{frontespizio.tex}, integrando direttamente l'ambiente frontespizio sul documento principale \texttt{main.tex}, tuttavia per una pulita struttura del progetto qui è stata presentata la procedura facente uso di un file separato.
